...
cleancss -d --source-map ${outpath}main.opt.css -o ${outpath}main.${now}.min.css
...
cleancss -d --source-map ${outpath}main.ie8.opt.css  -o ${outpath}main.ie8.${now}.min.css
...
cleancss -d --source-map ${outpath}print.opt.css -o ${outpath}print.${now}.min.css
...
cleancss -d --source-map ${outpath}print.ie8.opt.css -o ${outpath}print.ie8.${now}.min.css
...
cleancss -d --source-map ${outpath}datasets_credits.opt.css -o ${outpath}datasets_credits.${now}.min.css
