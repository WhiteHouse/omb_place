...
cleancss -d --source-map ../dist/assets/main.opt.css -o ../dist/assets/main.${now}.min.css
...
cleancss -d --source-map ../dist/assets/main.ie8.opt.css  -o ../dist/assets/main.ie8.${now}.min.css
...
cleancss -d --source-map ../dist/assets/print.opt.css -o ../dist/assets/print.${now}.min.css
...
cleancss -d --source-map ../dist/assets/print.ie8.opt.css -o ../dist/assets/print.ie8.${now}.min.css
...
cleancss -d --source-map ../dist/assets/datasets_credits.opt.css -o ../dist/assets/datasets_credits.${now}.min.css
#gzip -9 -c ../dist/assets/datasets_credits.min.css > ../dist/assets/datasets_credits.min.css.gz

# Fix file paths for fonts
perl -pi -e 's/url\(\.\.\/fonts\/fontawesome/url\(fonts\/fontawesome/g' ../dist/assets/main.${now}.min.css
perl -pi -e 's/url\(\.\.\/fonts\/fontawesome/url\(fonts\/fontawesome/g' ../dist/assets/main.ie8.${now}.min.css
perl -pi -e 's/url\(\.\.\/fonts\/fontawesome/url\(fonts\/fontawesome/g' ../dist/assets/print.${now}.min.css
perl -pi -e 's/url\(\.\.\/fonts\/fontawesome/url\(fonts\/fontawesome/g' ../dist/assets/print.ie8.${now}.min.css
perl -pi -e 's/url\(\.\.\/fonts\/fontawesome/url\(fonts\/fontawesome/g' ../dist/assets/datasets_credits.${now}.min.css
