...
echo -e "\033[1m\033[36mOptimizing for modern browsers: place/assets/main.min.js (place/assets/main.min.js.map)\033[0m\033[0m"
...
uglifyjs --source-map ../dist/assets/main.ie8.min.js.map --source-map-root http://localhost:8000/assets --source-map-url --prefix relative --output ../dist/assets/main.ie8.min.js --mangle --compress dead_code,loops,warnings,join_vars --reserved '$,L,map,window,data_obj' --stats --verbose -- ../assets/ie8_polyfills.js ../assets/jquery-1.11.2/jquery.min.js ../assets/spin-2.1.0/spin.min.js ../assets/leaflet-0.7.3/js/leaflet.js ../assets/leaflet-0.7.3/js/Leaflet.vector-markers.js ../assets/leaflet-0.7.3/js/leaflet-providers.js ../assets/leaflet-0.7.3/js/leaflet-pip.min.js ../assets/leaflet-0.7.3/js/leaflet.spin.js ../assets/leaflet-0.7.3/js/leaflet.geojsoncss.min.js ../assets/leaflet-0.7.3/js/l.control.geosearch.js ../assets/leaflet-0.7.3/js/l.geosearch.provider.openstreetmap.js ../assets/leaflet-0.7.3/js/L.Control.Pan.js ../assets/leaflet-0.7.3/js/L.Control.ZoomBox.min.js ../assets/leaflet-0.7.3/js/leaflet.zoomhome.min.js ../assets/leaflet-0.7.3/js/leaflet.groupedlayercontrol.min.js ../assets/main.js ./start-ie8.js
...
uglifyjs --source-map ../dist/assets/datasets_credits.min.js.map --source-map-root http://localhost:8000/assets --source-map-url --prefix relative --output ../dist/assets/datasets_credits.min.js --mangle --compress dead_code,loops,warnings,join_vars --reserved '$,window,data_obj' --stats --verbose -- ../assets/ie8_polyfills.js ../assets/jquery-1.11.2/jquery.min.js ../assets/datasets_credits.js
